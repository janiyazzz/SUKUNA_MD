...
module.exports = {
    ...
    async execute({ sock, msg, from, sender, reply, phoneNumber, t: _t }) {
        ...
        // ===== Read More — force WhatsApp to collapse the menu =====
        // WhatsApp only shows "Read more" when the text is very long.
        // We append 4000 invisible right-to-left marks so the menu text
        // is always truncated behind the "Read more" button.
