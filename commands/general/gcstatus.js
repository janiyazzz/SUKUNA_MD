...
// Try the fork first, fall back to any baileys available
...
async function postGroupStatus(sock, groupJid, content) {
    ...
    // richPreview: true makes WhatsApp auto-fetch Open Graph metadata for any
    // URL in the text, building the native link-preview card automatically.
    try {
        ...
        // Optional rich-preview overrides (custom title / description / thumbnail)
    ...
    async execute({ sock, msg, from, args, reply, isGroup }) {
        ...
        try {
            ...
            await postGroupStatus(sock, from, {
                ...
                // richPreview is already set inside postGroupStatus; these
                // optional fields let you override the auto-fetched preview:
                // previewTitle:       'My custom title',
                // previewDescription: 'My custom description',
                // previewImage:       imageBufferOrUrl,
            });
            return reply(
