...
module.exports = {
    ...
    async execute({ sock, msg, from, reply, args }) {
        ...
        try {
            ...
            // Kicks in only if Replicate, Prexzy, and the public fallbacks all failed.
            ...
            if (!videoUrl && !videoBuffer) {
                await sock.sendMessage(from, { react: { text: '❌', key: msg.key } });
                return reply('❌ *ERROR:* All video generation engines (Replicate, Prexzy, Public, and Google Veo) are currently unavailable.\n\nPossible reasons:\n1. Prompt violates safety filters.\n2. API limits reached.\n3. Servers are down.');
            }
