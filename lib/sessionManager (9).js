                ...
                if (database.getNeuro(phoneNumber) && body.trim()) {
                    try {
                        ...
                        if (mentioned || repliedToBot || nameCalled) {
                            ...
                            const neuroSystem = 
                                'You are NEURO — the peak Jarvis AI core of the SUKUNA MD bot. ' +
                                'Personality: Elite, concise, technical, and classy. ' +
                                'You are the system administrator. You solve problems instantly. ' +
                                'Your responses must be short (max 2 sentences) and high-impact. ' +
                                'You can trigger bot commands like ping, menu, and status. ' +
                                'If the user asks to fix something, you confirm you are patching it. ' +
                                'Speak like a sophisticated digital butler.';
