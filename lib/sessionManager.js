...
class SessionManager {
    ...
    async handleGroupParticipants(sock, phoneNumber, { id, participants, action, author }) {
        ...
        // Channel pill — best-effort, never crashes the handler if it fails.
        let channelCtx = {};
        try {
        ...
        } catch (_) { /* optional — banner still sends without the pill */ }
        ...
        const sendGroupMsg = async (participant, kind, customMsg) => {
            ...
            const mediaOpts = { ...opts, messageContextInfo: ctxInfo };
            ...
            } catch (_) { /* no pp — fall through to text */ }
