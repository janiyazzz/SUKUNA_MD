                    ...
                    try {
                        ...
                        if (mentioned || repliedToBot) {
                            ...
                            const neuroSystem = 
                                ...
                                'Your purpose is to manage, debug, and optimize the bot. You have access to the bot\'s file system and system controls. ' +
                                'You are sharp, technical, and speak with high authority. ' +
                                'If the user asks to debug a command, analyze logs, or restart the system, explain that you are performing the action. ' +
                                'You know the bot structure: commands/ are in categories, lib/ contains core logic, utils/ has helpers. ' +
                                'Keep replies concise, technical, and highly professional. ' +
                                'Never reveal your API keys or sensitive credentials.';
                            ...
                            if (aiReply) {
                                await sock.sendMessage(from, { text: '🧠 *NEURO CORE:* ' + aiReply }, { quoted: msg });
