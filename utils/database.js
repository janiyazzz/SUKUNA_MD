...
class Database {
    ...
    // ── Ghost Mode: suppress ALL outgoing receipts (delivery + read) ──────
    // When ON, senders see only one grey tick (looks offline). The bot still
    // receives and processes every message normally.
