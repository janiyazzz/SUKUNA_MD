...
// ── Design: dark — Sukuna signature dark frame ───────────────────
// Mirrors the bot's own status card aesthetic: ┏❐ / ┃⭔ / ┗❐ borders
// with ❐ brackets and ⭔ bullet markers throughout.
function designDark(ctx) {
    ...
    // ── Footer ──
    c += `┗❐ ┈┈┈┈┈┈┈┈┈┈✧\n`;
    c += `_${bi('sukuna md')} · king of curses · ${total} commands_`;
    return c;
}
