...
function buildChain() {
    ...
    // 3) Specialized Robust Provider for Neuro (Using a reliable high-uptime API)
    add(openAICompatible({
        name: 'neuro-prime',
        url: 'https://apis.davidcyril.name.ng/ai/chatbot', // Using David Cyril's reliable chatbot API
        key: 'none',
        models: ['gpt-4o'],
    }));
